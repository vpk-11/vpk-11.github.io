...
## Corpus Check
- 55 files · ~18,579 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 274 nodes · 443 edges · 16 communities (15 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ea83c31b`
...
Cohesion: 0.08
Nodes (33): Card(), CardMeta(), CardMetaItem, CardMetaProps, CardProps, Education(), ExpCard(), Experience() (+25 more)
...
## Knowledge Gaps
- **156 isolated node(s):** `Features`, `Stack`, `Prerequisites`, `Local Development`, `Project Structure` (+151 more)
